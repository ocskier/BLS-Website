  ...
  return (
    <nav>
      ...
      <SideNav
        ...
        >
          <SideNavItem waves button href='' icon={
            <ListItemIcon>
              <MySvgIcon>
          ...
          <SideNavItem waves button onClick={()=> clickOpen()} href='' icon={
            <ListItemIcon>
              <MySvgIcon>
          ...
          <Link to="/"><p className="brand-logo center">{props.children}</p></Link>
      </div>
    </nav>
  )
};
